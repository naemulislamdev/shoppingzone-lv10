...
<div class="offcanvas offcanvas-end" tabindex="-1" id="clientReviewAdd" aria-labelledby="offcanvasExampleLabel">
    <div class="offcanvas-header">
        <h5 class="offcanvas-title" id="offcanvasExampleLabel">Client Review</h5>
        <i class="fa fa-close offcanvasClose" data-bs-dismiss="offcanvas" aria-label="Close"></i>
    </div>
    <div class="offcanvas-body">
        <form action="{{ route('client_review') }}" method="POST">
            @csrf
            <div class="row">
